 ...
 *  @author Kevin Wayne
 */
public class V_IndexMinPQ<Key extends Comparable<Key>> implements Iterable<Integer> {
    ...
    **********************************************************************/
    ...
    private class HeapIterator implements Iterator<Integer> {
        // create a new pq
        private V_IndexMinPQ<Key> copy;

        // add all elements to copy of heap
        // takes linear time since already in heap order so no keys move
        public HeapIterator() {
            copy = new V_IndexMinPQ<Key>(pq.length - 1);
            for (int i = 1; i <= N; i++)
